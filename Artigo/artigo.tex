...
Seja $V$ a matriz coluna que representa as tensões das fontes de tensão de corrente contínua do circuito, $R$ a matriz das resistências e $I_b$ a matriz coluna que representa as correntes em cada um dos galhos (arestas) do circuito, tem-se, pela lei das tensões de kirchoff:
